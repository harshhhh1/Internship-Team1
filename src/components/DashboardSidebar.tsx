  ...
  return (
    <div className="w-64 min-h-screen bg-bg-light border-r border-gray-200 p-5 flex flex-col fixed left-0 top-0 z-10">
       <h3 className="mb-6 pl-2 text-xl font-bold text-gray-800">Admin Panel</h3>
         ...
         <NavLink to="/dashboard/reviews" className={linkClasses}><img src='/reviews.svg' alt="Reviews"/>Reviews</NavLink>
       </nav>
      <NavLink to="/dashboard/settings" className={linkClasses}><img src='/settings.svg' alt="Settings"/>Settings</NavLink>
     </div>
  );
}
