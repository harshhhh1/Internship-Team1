...
import '../../styles/reportandrevenue.css'
...
const RevenueReport = () => {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#f6f7fb', fontFamily: 'Inter, system-ui' }}>
      <AdminSidebar />

      <div className="rev-container" style={{ flex: 1, padding: '32px', overflowY: 'auto' }}>
